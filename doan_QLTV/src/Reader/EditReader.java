...
public class EditReader extends JDialog {
     ...
     */
    public EditReader(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Sửa thông tin người đọc");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("      SỬA THÔNG TIN NGƯỜI ĐỌC   ");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Thông tin người đọc"));

        jLabel2.setText("Mã Người đọc:");

        jLabel3.setText("Tên Người đọc:");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditReader dialog = new EditReader(new javax.swing.JFrame(), true);
