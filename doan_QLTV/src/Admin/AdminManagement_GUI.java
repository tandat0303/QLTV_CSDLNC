 ...
 * @author nguye
 */
public class AdminManagement_GUI extends javax.swing.JFrame {

    /**
     * Creates new form Test
     */
    public AdminManagement_GUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        comboSearch.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Mã Người quản trị", "Tên Người quản trị", "Số Điện Thoại" }));
        ...
        jLabel1.setText("Mã người quản trị:");
        ...
        jLabel2.setText("Tên người quản trị:");
        ...
        infoTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Người quản trị", "Tên Người quản trị", "Giới Tính", "Ngày Sinh", "Địa Chỉ", "Email", "Số Điện Thoại"
            }
        ) {
        ...
        if (infoTable.getColumnModel().getColumnCount() > 0) {
            infoTable.getColumnModel().getColumn(2).setMaxWidth(60);
        }
        ...
        jMenu1.setText("Quản lý người quản trị");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminManagement_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminManagement_GUI().setVisible(true);
            }
        });
    }
