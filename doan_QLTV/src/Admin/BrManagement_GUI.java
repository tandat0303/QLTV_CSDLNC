 ...
 * @author hvu31
 */
public class BrManagement_GUI extends javax.swing.JFrame {

    /**
     * Creates new form BrManagement_GUI
     */
    public BrManagement_GUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrManagement_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BrManagement_GUI().setVisible(true);
            }
        });
    }
